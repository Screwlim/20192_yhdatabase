...
for line in rdr_d:                                          #line[1] : protocol
    ...
    for m in range(71) :
     if(line[2]==label[m]) : line[2]=(m+1)              #line[2] : service
    ...
    #wr_d.writerow(line+['1'])  for non-Label make label value(0 : normal , 1 : abnormal)
    wr_d.writerow(line[:28])        #output1 some feature
    wr_di.writerow(line[28:29])     #output2 only ip address
